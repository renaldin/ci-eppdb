                ...
                <div class="box box-success box-solid">
                    <div class="box-header with-border">
                        ...
                        <div class="box-tools pull-right">
                            <a href="<?= base_url('/laporan/printSemuaLulus') ?>" target="_blank" class="btn btn-box-tool"><i class="fa fa-print"> Print Semua</i></a>
                        </div>
                        <!-- /.box-tools -->
                    </div>
                    <!-- /.box-header -->
                                ...
                                foreach ($pendaftaran as $row) { ?>
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a href="<?= base_url('/laporan/detailLulus/' . $row['id_pendaftaran']) ?>" class="btn btn-primary btn-sm btn-flat"><i class="fa fa-list"></i> Detail</a>
